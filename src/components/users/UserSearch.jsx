...
const UserSearch = () => {
  ...
  return (
    <div>
      <h2 className="text-slate-900 text-center text-4xl font-bold my-12 dark:text-slate-200">
        Enter a username <span className="text-indigo-700">to Search</span>
      </h2>
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex mb-12 gap-2 items-center justify-center">
          <div className="group relative w-5/6 sm:max-w-lg ">
            <svg
              ...
              height="20"
              fill="currentColor"
              className="absolute left-3 top-1/2 -mt-2.5 text-indigo-400 pointer-events-none group-focus-within:text-indigo-700"
              aria-hidden="true"
            >
              <path
                fillRule="evenodd"
            ...
            <input
              className="focus:ring-2 focus:ring-indigo-700 focus:outline-none w-full appearance-none  text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md py-2 pl-10 pr-4 ring-1 ring-slate-200 shadow-sm"
              type="search"
          ...
          <button className="bttn-2 bttn-primary mr-4" type="submit">
            Go
          </button>
        </div>
        ...
        <div className="mt-5 sm:mt-8 flex justify-center">
          {users.length > 0 && (
            <button className="bttn-2 bttn-secondary" onClick={clearUI}>
              Clear All
            </button>
          )}
        </div>
